...
const (
	BucketAdminService_ListBuckets_FullMethodName  = "/couchbase.admin.bucket.v1.BucketAdminService/ListBuckets"
	BucketAdminService_CreateBucket_FullMethodName = "/couchbase.admin.bucket.v1.BucketAdminService/CreateBucket"
	BucketAdminService_UpdateBucket_FullMethodName = "/couchbase.admin.bucket.v1.BucketAdminService/UpdateBucket"
	BucketAdminService_DeleteBucket_FullMethodName = "/couchbase.admin.bucket.v1.BucketAdminService/DeleteBucket"
	BucketAdminService_FlushBucket_FullMethodName  = "/couchbase.admin.bucket.v1.BucketAdminService/FlushBucket"
)
...
func (c *bucketAdminServiceClient) ListBuckets(ctx context.Context, in *ListBucketsRequest, opts ...grpc.CallOption) (*ListBucketsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BucketAdminService_ListBuckets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bucketAdminServiceClient) CreateBucket(ctx context.Context, in *CreateBucketRequest, opts ...grpc.CallOption) (*CreateBucketResponse, error) {
	...
	err := c.cc.Invoke(ctx, BucketAdminService_CreateBucket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bucketAdminServiceClient) UpdateBucket(ctx context.Context, in *UpdateBucketRequest, opts ...grpc.CallOption) (*UpdateBucketResponse, error) {
	...
	err := c.cc.Invoke(ctx, BucketAdminService_UpdateBucket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bucketAdminServiceClient) DeleteBucket(ctx context.Context, in *DeleteBucketRequest, opts ...grpc.CallOption) (*DeleteBucketResponse, error) {
	...
	err := c.cc.Invoke(ctx, BucketAdminService_DeleteBucket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bucketAdminServiceClient) FlushBucket(ctx context.Context, in *FlushBucketRequest, opts ...grpc.CallOption) (*FlushBucketResponse, error) {
	...
	err := c.cc.Invoke(ctx, BucketAdminService_FlushBucket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBucketAdminServiceServer must be embedded to have
...
func (UnimplementedBucketAdminServiceServer) testEmbeddedByValue()                            {}
...
func RegisterBucketAdminServiceServer(s grpc.ServiceRegistrar, srv BucketAdminServiceServer) {
	// If the following call pancis, it indicates UnimplementedBucketAdminServiceServer was
...
func _BucketAdminService_ListBuckets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BucketAdminService_ListBuckets_FullMethodName,
	}
...
func _BucketAdminService_CreateBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BucketAdminService_CreateBucket_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BucketAdminService_UpdateBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BucketAdminService_UpdateBucket_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BucketAdminService_DeleteBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BucketAdminService_DeleteBucket_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BucketAdminService_FlushBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BucketAdminService_FlushBucket_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
