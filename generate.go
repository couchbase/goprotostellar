//go:generate rm -rf ./genproto
//go:generate mkdir ./genproto
//go:generate -command protostellar protoc --proto_path=./contrib/protostellar --proto_path=./contrib/googleapis --go_out=./genproto --go_opt=module=github.com/couchbase/goprotostellar/genproto --go-grpc_out=./genproto --go-grpc_opt=module=github.com/couchbase/goprotostellar/genproto
...
//go:generate protostellar couchbase/routing/v2/routing.proto
